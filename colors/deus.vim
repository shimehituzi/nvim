...
let s:ds.gray_245    = ['#928374', 232]     " 146-131-116
let s:ds.gray_244    = ['#928374', 244]     " 146-131-116

let s:ds.light0      = ['#d2d2d2', 229]     " 253-244-193
let s:ds.light1      = ['#ebdbb2', 254]     " 235-219-178
...
call s:HL('htmlBold', s:red, s:none, s:bold)
call s:HL('htmlBoldUnderline', s:vim_fg, s:vim_bg, s:bold . s:underline)
call s:HL('htmlBoldItalic', s:red, s:none, s:bold . s:italic)
...
call s:HL('markdownItalic', s:bg1, s:none, s:italic)
...
hi! link markdownCodeDelimiter deusBlue

hi! link markdownBlockquote deusBlue
hi! link markdownListMarker deusPurple
hi! link markdownOrderedListMarker deusOrange
hi! link markdownRule deusRed
hi! link markdownHeadingRule deusGreen

hi! link markdownUrlDelimiter deusBg1
hi! link markdownLinkDelimiter deusBg1
hi! link markdownLinkTextDelimiter deusBg1
