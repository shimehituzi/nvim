...
map('n', '1', builtin.current_buffer_fuzzy_find)
map('n', '2', builtin.buffers)
map('n', '3', builtin.live_grep)
map('n', '4', builtin.git_status)
map('n', '5', builtin.git_bcommits)
map('n', '6', builtin.help_tags)
map('n', '7', builtin.diagnostics)
map('n', '8', extnsions.noice.noice)
map('n', '9', builtin.lsp_document_symbols)
