...
return {
  keymaps = {
    ...
    view = {
      ...
      { 'n', '<S-Up>', '<cmd>DiffviewClose<cr>', { desc = 'Close the Diffview Tab' } },
      { 'n', '<S-Down>', '<cmd>DiffviewClose<cr>', { desc = 'Close the Diffview Tab' } },
    ...
    file_panel = {
      ...
      { 'n', '<S-Down>', '<cmd>DiffviewClose<cr><cmd>DiffviewFileHistory<cr>', { desc = 'Close the Diffview Tab and Open the DiffviewFileHistory Tab' }, },
      { 'n', '<S-Up>', '<cmd>DiffviewClose<cr>', { desc = 'Close the Diffview Tab' } },
      { 'n', 'q', '<cmd>DiffviewClose<cr>', { desc = 'Close the Diffview Tab' } },
      { 'n', '<C-q>', '<cmd>DiffviewClose<cr>', { desc = 'Close the Diffview Tab' } },
    ...
    file_history_panel = {
      ...
      { 'n', ';', actions.toggle_files, { desc = 'Toggle the file panel' } },
      { 'n', ',', actions.cycle_layout, { desc = 'Cycle available layouts' } },
      { 'n', '<S-Up>', '<cmd>DiffviewClose<cr><cmd>DiffviewOpen<CR>', { desc = 'Close the DiffviewFileHistory Tab and Open the Diffview Tab' } },
      { 'n', '<S-Down>', '<cmd>DiffviewClose<cr>', { desc = 'Close the DiffviewFileHistory Tab' } },
