...
return {
  keymaps = {
    ...
    view = {
      ...
      { 'n', '_', '<cmd>DiffviewClose<cr>', { desc = 'Close the Diffview Tab' } },
    ...
    file_panel = {
      ...
      { 'n', '_', '<cmd>DiffviewClose<cr><cmd>DiffviewFileHistory<cr>', { desc = 'Close the Diffview Tab and Open the DiffviewFileHistory Tab' } },
      { 'n', '-', '<cmd>DiffviewClose<cr>', { desc = 'Close the Diffview Tab' } },
      { 'n', 'q', '<cmd>DiffviewClose<cr>', { desc = 'Close the Diffview Tab' } },
      { 'n', '<C-q>', '<cmd>DiffviewClose<cr>', { desc = 'Close the Diffview Tab' } },
    ...
    file_history_panel = {
      ...
      { 'n', '_', '<cmd>DiffviewClose<cr>', { desc = 'Close the DiffviewFileHistory Tab' } },
